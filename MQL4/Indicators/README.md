...
5. Keep `UseVisibleChartTime` enabled when using Soft4FX Forex Simulator or Strategy Tester so profiles are anchored to the visible/tested chart date instead of the broker/server current date.
